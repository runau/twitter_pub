...
def main():
    ...
    ngList=["融資",'R18','R-18','例のアレ','アヘ顔','亀頭','へんたい','ヘンタイ','変態','パンチラ',
            'アッー','アナル','アヘ顔','イマラ','淫','エッチ','おっぱい','オッパイ','オナシャス','ガチムチ',
            '姦','元祖羞恥心','亀頭','糞','クルルァ','グロ','ゲイ',
            '18禁','春画','処女','ショタ','パイパン','フェラ','ふたなり','ペニス','へんたい','ヘンタイ','変態','ホモ','まんこ','マンコ','野獣','幼女','レイプ','レズ','セックス','せっくす',
            'アダルト','セックス','バイブレーター','マスターベーション','オナニー','スケベ','羞恥','セクロス',
